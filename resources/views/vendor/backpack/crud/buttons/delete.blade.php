			...
			if (value) {
				$.ajax({
			      ...
			      error: function(result) {
                      let errorText = "{!! trans('backpack::crud.delete_confirmation_not_message') !!}";

                      if (typeof result.responseJSON.message !== 'undefined' || result.responseJSON.message !== null) {
                          errorText = result.responseJSON.message;
                      }
